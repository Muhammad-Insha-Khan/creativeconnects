...
import { FaCog, FaUser, FaBell, FaFileAlt, FaSignOutAlt, FaJoint, FaAccusoft } from 'react-icons/fa';
import Clickabletext from './Clickabletext';
import Dropdown from './Dropdown';
import Notification from './Notification';
import { useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2';
import AccountPopupSeller from './AccountPopupSeller';
import AllProjectProposals from './AllProjectProposals';
      ...
      <div className="desktop-header">
        ...
        <div className="actions">
          ...
          <Clickabletext
            icon={FaAccusoft}
            text="Projects"
            onClick={() => navigate('/All-ProjectProposal')}
          />
          <Clickabletext

            icon={FaBell}
            text="Jobs"
            onClick={() => navigate('/All-JobDiscriptionShow')}
          />
          <Clickabletext
            icon={FaUser}
            text="Account"
